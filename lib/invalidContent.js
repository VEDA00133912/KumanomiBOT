const invalidContentChecks = [
  ...
  { regex: /https?:\/\/[^\s]+/, error: '<:error:1299263288797827185> 一般的なリンクを含むメッセージは送信できません。' },
  ...
  { regex: /(discord\.com|discord\.gg|invite|https|http)/i, error: '<:error:1299263288797827185> リンクを含むことはできません。' }
];
